...
class Iku2prestasiModel extends Model
{
    ...
    protected $allowedFields    = ['NIM', 'tahun','NIDN', 'nama_kompetisi','penyelenggara','tingkat_kompetisi', 'prestasi', 'countries', 'provinces', 'jmlh_peserta', 'jmlh_provinsi_mengikuti', 'jmlh_negara_mengikuti', 'sertifikat'];
